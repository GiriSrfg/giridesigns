...
function SiteHeader({
  ...
  return (
    <nav className='fixed left-0 right-0 top-0 z-50 bg-black/80 backdrop-blur-md'>
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between border-b border-white/20 pb-5 pt-6'>
        <motion.a
          href='#'
          onClick={(event) => {
            setIsMenuOpen(false)
          ...
          className='text-2xl font-light leading-none tracking-[-0.03em] text-white transition hover:text-white/80'
        >
          Portfolio
        </motion.a>
        ...
        <button
          ...
          className='inline-flex items-center gap-3 text-xl font-light leading-none tracking-[-0.03em] text-white/70 hover:text-white md:hidden'
        >
      ...
      <AnimatePresence>
        {isMenuOpen ? (
          ...
          >
            ...
            <div className='relative max-w-7xl mx-auto flex flex-col items-end gap-10 pt-6'>
              {siteNavLinks.map((item) => {
                ...
                return (
                  <a
                    ...
                    href={item.href}
                    onClick={(event) => handleLinkClick(event, item.href)}
                    className={`text-[clamp(2.5rem,8vw,4rem)] font-light lowercase leading-none tracking-[-0.05em] transition hover:text-white ${
                      isActive ? 'text-white font-medium' : 'text-white/55'
                    }`}
                  >
                    {item.label}
...
function ContactSection({ onContactClick }: { onContactClick?: () => void }) {
  ...
  return (
    <section
      id="contact"
      className="relative bg-transparent py-16 sm:py-24 text-white overflow-hidden"
    >
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Section Header */}
        <div className="flex items-center gap-4 w-full mb-12">
        ...
        <div className="flex flex-col gap-12 sm:gap-16">
          {/* Large Title Text */}
          <h2 className="text-[clamp(1.4rem,3.4vw,2.6rem)] font-light leading-[1.25] tracking-tight max-w-4xl font-sans text-neutral-200">
          ...
          <div className="flex flex-col sm:flex-row items-start w-full">
            <div className="w-full sm:w-auto sm:min-w-[240px]">
              <a
                ...
                className="relative flex items-center justify-center py-5 px-8 border border-white/20 overflow-hidden select-none transition-colors duration-300 w-full rounded-sm"
              >
...
function SiteFooter({
  ...
  return (
    <footer className="relative bg-transparent py-16 text-white overflow-hidden font-sans border-t border-white/10">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col gap-16">
        ...
        <div className="flex flex-col gap-6 w-full">
          ...
          <div className="max-w-3xl">
            <h2 className="text-[clamp(1.5rem,3.5vw,2.8rem)] font-light leading-snug tracking-tight text-neutral-300 font-sans">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 w-full gap-12 pt-4">
          {/* Form Container */}
            ...
            <form className="flex flex-col gap-6 w-full" onSubmit={(e) => e.preventDefault()}>
              <div className="flex flex-col gap-2">
                ...
                <input
                  ...
                  required
                  placeholder="Name"
                  className="w-full bg-[#121212] border border-white/10 rounded-sm py-4 px-6 text-white placeholder-white/40 focus:outline-none focus:border-white/50 focus:ring-1 focus:ring-white/50 transition duration-300"
                />
              </div>
              <div className="flex flex-col gap-2">
              ...
              <div className="flex flex-col gap-2">
                ...
                <textarea
                  ...
                  required
                  placeholder="Message"
                  className="w-full bg-[#121212] border border-white/10 rounded-sm py-4 px-6 text-white placeholder-white/40 focus:outline-none focus:border-white/50 focus:ring-1 focus:ring-white/50 transition duration-300 resize-none"
                />
              </div>
              ...
              <button
                type="submit"
                className="w-full bg-white text-black font-semibold uppercase tracking-wider py-4 hover:bg-neutral-200 transition duration-300 mt-2 text-sm rounded-sm"
              >
                Submit
              </button>
            </form>
  ...
  return (
    <div className="relative bg-transparent min-h-screen text-white pt-[140px] pb-24 overflow-hidden font-sans">
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col gap-16">
        ...
        {/* Projects List */}
        <div className="flex flex-col gap-16 sm:gap-24 w-full mt-4">
          {projects.map((project) => {
            ...
            return (
              <div
                key={project.name}
                className="grid grid-cols-1 md:grid-cols-12 w-full gap-8 items-start border-b border-white/5 pb-16 last:border-b-0"
              >
                {/* Main Card Container */}
    ...
    <div className="relative bg-transparent min-h-screen text-white pt-[140px] pb-24 overflow-hidden font-sans">
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col gap-16">
        ...
        <div className="flex flex-col gap-6 w-full relative">
          <h1 className="text-[clamp(4rem,10vw,8rem)] font-light tracking-[-0.05em] text-white select-none leading-none">
            focus
          </h1>
        </div>
        ...
        <div className="flex flex-col gap-6 relative border-b border-white/10 pb-16">
          ...
          <div 
            ...
            className="aspect-[16/9] w-full overflow-hidden rounded-xl border border-white/10 bg-neutral-900 cursor-pointer group"
          >
            <img
        ...
        <div className="flex flex-col gap-16 w-full">
          {listItems.map((item) => (
            <div 
              key={item.id}
              className="grid grid-cols-1 md:grid-cols-12 w-full gap-6 items-start border-b border-white/5 pb-16 last:border-b-0 relative"
            >
              {/* Image */}
              <div 
                onClick={() => onSelectItem(item.id)}
                className="md:col-span-5 aspect-[16/10] w-full overflow-hidden rounded-lg border border-white/10 bg-neutral-900 cursor-pointer group"
              >
                <img
                  src={item.image}
                  alt={item.title}
              ...
              <div className="md:col-span-7 flex flex-col gap-3 md:pt-4">
                ...
                <p className="text-sm text-neutral-400 font-light max-w-prose">
                  {item.subtitle}
                </p>
                <span className="font-mono text-xs lowercase text-white/45">
                  {item.date}
    ...
    <div className="relative bg-transparent min-h-screen text-white pt-[140px] pb-24 overflow-hidden font-sans">
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col gap-16">
        ...
        <div className="flex flex-col gap-6 max-w-4xl">
          ...
          {/* Outlined Badge */}
          <div>
            <span className="inline-flex items-center gap-1.5 px-4 py-2 border border-white/20 text-xs font-mono lowercase text-white/60 tracking-wider rounded-sm">
              in focus ↗
            </span>
          </div>
        </div>
              ...
              if (sec.type === 'text') {
                ...
                return (
                  <div key={idx} className="flex flex-col gap-4 p-6 sm:p-8 bg-white/[0.03] border border-white/10 rounded-lg">
                    ...
                    <p className="italic text-neutral-300 font-light">
                      "{sec.text}"
                    </p>
                  </div>
                )
          ...
          {data.seeAlso.map((item, index) => {
            ...
            return (
              <a
                ...
                className="group relative flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 py-8 border-b border-white/10 cursor-pointer select-none transition-opacity duration-300"
                style={{
                  opacity: isDimmed ? 0.6 : 1
                }}
              >
